...
def test_cli_bad_geom(tmpdir: str):
    """ tests the cli """
    runner = CliRunner() # capture stderr
    result = runner.invoke(
        cli,
...
def test_cli_bad_filename(tmpdir: str):
    """ tests the cli """
    runner = CliRunner() # capture stderr
...
def test_cli_missing_file(tmpdir: str):
    """ tests the cli """
    runner = CliRunner() # capture stderr
...
def test_cli_file_exists_bail(tmpdir: str):
    """ tests the cli """
    runner = CliRunner() # capture stderr
    result = runner.invoke(
        cli,
...
def test_cli_file_write_weird_extension(tmpdir: str):
    """ tests the cli """
    runner = CliRunner() # capture stderr
    result = runner.invoke(
        cli,
